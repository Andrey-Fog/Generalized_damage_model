subroutine material_jacobian_wrapper(params, vars, J)
    implicit none
    REAL*8, intent(in) :: params(60)
    REAL*8, intent(in) :: vars(42)
    REAL*8, intent(out) :: J(42,42)
    REAL*8 :: out_result(42,42)
     !var_mapping = [
     !       "Variables (42 total):",
     ...
     !   ]
    ! Âûçîâ îğèãèíàëüíîé ïğîöåäóğû ñ ïåğåäà÷åé âñåõ ïàğàìåòğîâ è ïåğåìåííûõ
    call material_jacobian( &
        ! Ïàğàìåòğû par01-par07
        params(1), params(2), params(3), params(4), params(5), params(6), params(7), &
        ! Îñòàëüíûå ïàğàìåòğû (par40, par42-par60)
        params(40), params(42), params(43), params(45), params(46), params(47), params(48), &
        params(49), params(50), params(51), params(52), params(53), params(54), params(55), &
        params(56), params(57), params(58), params(59), params(60), &
        ! Ïåğåìåííûå var01-var42 (âñå êğîìå var03)
        vars(1), vars(2), vars(4), vars(5), vars(6), vars(7), vars(8), vars(9), vars(10), &
        vars(11), vars(12), vars(13), vars(14), vars(15), vars(16), vars(17), vars(18), vars(19), &
        vars(20), vars(21), vars(22), vars(23), vars(24), vars(25), vars(26), vars(27), vars(28), &
        vars(29), vars(30), vars(31), vars(32), vars(33), vars(34), vars(35), vars(36), vars(37), &
        vars(38), vars(39), vars(40), vars(41), vars(42), &
        ! Âûõîäíàÿ ìàòğèöà
        out_result)

    ! Ïğåîáğàçîâàíèå ğåçóëüòàòà â ìàòğèöó ßêîáè
    J = out_result
