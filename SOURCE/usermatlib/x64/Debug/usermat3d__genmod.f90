        !COMPILER-GENERATED INTERFACE MODULE: Thu Nov  6 15:26:01 2025
        ! This source file is for reference only and may not completely
        ! represent the generated interface used by the compiler.
        MODULE USERMAT3D__genmod
          INTERFACE 
            SUBROUTINE USERMAT3D(MATID,NOEL,NPT,LAYER,KSPT,JSTEP,KINC,  &
